              ...
              <CardContent className="p-5 sm:p-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                  <div>
                    ...
                    {primary ? (
                      <Link href={`/client-portal/work-orders/${primary.id}`} className="inline-flex items-center gap-2 mt-1 text-blue-700 hover:underline">
                      ...
                      {workOrders.map((wo) => (
                        <tr key={wo.id} className="hover:bg-muted transition-colors">
                          <td className="px-5 py-3.5">
                            <Link href={`/client-portal/work-orders/${wo.id}`} className="font-semibold text-foreground hover:underline">
                          ...
                          <td className="px-5 py-3.5 text-right">
                            <Button size="sm" variant="outline" asChild className="h-8">
                              <Link href={`/client-portal/work-orders/${wo.id}`}>View</Link>
                            </Button>
                          </td>
                        </tr>
                      ))}
