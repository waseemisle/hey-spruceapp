      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #f9fafb; padding: 30px; border-radius: 0 0 8px 8px;">
          ...
          <p style="font-size: 12px; color: #6b7280; text-align: center;">
            ...
            Phone: <a href="tel:1-877-253-26464" style="color: #10b981; text-decoration: none;">1-877-253-26464</a> | 
            Email: <a href="mailto:info@heyspruce.com" style="color: #10b981; text-decoration: none;">info@heyspruce.com</a> | 
            Website: <a href="https://www.heyspruce.com/" style="color: #10b981; text-decoration: none;">www.heyspruce.com</a>
          </p>
        </div>
      </body>
      </html>
