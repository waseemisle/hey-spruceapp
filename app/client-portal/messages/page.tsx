...
export default function ClientMessages() {
  ...
  useEffect(() => {
    ...
    // client-side for chronological display. Caps the load on long-running
    // threads; "load earlier" pagination is a future enhancement.
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      void markBadgeViewed(db, 'client', currentUser.uid, 'messages');
  ...
  return (
    <>
      {/*
        ...
        right pane. This avoids the "page scrollbar + chat scrollbar"
        anti-pattern on long conversations.
      */}
